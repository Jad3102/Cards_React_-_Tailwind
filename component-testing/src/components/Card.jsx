...
const Card = ({title, subtitle, rating, backgroundColors, className, image}) => {
    return (
        <div className={'card flex flex-col justify-center p-5 rounded-[10%] relative text-white overflow-hidden h-fit w-fit z-10 hover:-translate-y-10 transition-all duration-300 ' + className}
        style={{
          background: `linear-gradient(to bottom, ${backgroundColors.top}, ${backgroundColors.bottom})`,
        }}>
            <div className="inset-0 absolute z-0"></div> 
            ...
            <div className="bg-[rgba(0,0,0,4)] flex items-center pl-1 pr-2 py-1 rounded-3xl gap-2">
            ...
            <img src={image} alt={title} className="w-52 h-52 object-contain mt-5 drop-shadow-[0_2px_2px_rgba(0,0,0,0.3)] mx-5 mb-7"/>
        </div>
    )
}
